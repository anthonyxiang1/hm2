...
def match_team(user, team):
    interests = load_constants('/Users/admin/Desktop/Projects/hm/server/tests/interests.txt')
    languages = load_constants('/Users/admin/Desktop/Projects/hm/server/tests/languages.txt')
    fields = load_constants('/Users/admin/Desktop/Projects/hm/server/tests/fields.txt')
    technologies = load_constants('/Users/admin/Desktop/Projects/hm/server/tests/technologies.txt')

    interest_score = score_arr_to_scalar(compute_preference_score(user['interests'], team['interests'], interests))
    language_score = score_arr_to_scalar(compute_preference_score(user['languages'], team['languages'], languages))
    technology_score = score_arr_to_scalar(compute_preference_score(user['technologies'], team['technologies'], technologies))
    field_score = score_arr_to_scalar(compute_preference_score(user['fields'], team['fields'], fields))

    similiarity_score = interest_score + language_score + technology_score + field_score
    return similiarity_score